...
$$
where $X$ is a matrix of predictors and $\beta$ is a (column) vector of slopes/effect sizes. We will use both notations in the vignette, although this matrix notation is a bit more compact and relates most easily the structure of the the `simulate_population()` function.

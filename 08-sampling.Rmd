...
## Missing data
The missing data methods allows generation of unbalanced data. Missing data is generated through creating probabilities of being sampled using logistic regression. Missingness can then wither be random, or a function of any of the simulated variables. 
...
- **M**issing **A**t **R**andom (MAR)
    - Probability of missingness is dependent a variables correlated with the response variable (i.e. a predictor variable)
